...
|----|----------|-------------|----------|
| PB1 | Add New Task | Create a task with title and description | High |
| PB2 | Assign Task | Assign task to a registered user | High |
...
- At least one commit per team member
- Feature reviewed and approved via Pull Request
